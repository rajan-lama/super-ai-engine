...
require_once( SAI_ENGINE_PATH . '/constants/engines.php' );
require_once( SAI_ENGINE_PATH . '/constants/models.php' );

define( 'SAI_ENGINE_CHATBOT_DEFAULT_PARAMS', [
  // UI Parameters
  'aiName' => 'AI: ',
  'userName' => 'User: ',
  'guestName' => 'Guest: ',
  ...
  'embeddingsEnvId' => '',
  // AI Parameters
  'model' => SAI_ENGINE_FALLBACK_MODEL,
  'temperature' => 0.8,
  'maxMessages' => 15,
  'maxTokens' => 4096,
  'maxResults' => 1,
...
define( 'SAI_ENGINE_OPTIONS', [
  ...
  'ai_default_env' => null,
  'ai_default_model' => SAI_ENGINE_FALLBACK_MODEL,
  'ai_envs' => [
    [
      'name' => 'OpenAI',
      'type' => 'openai',
  ...
  'ai_fast_default_model' => SAI_ENGINE_FALLBACK_MODEL,
  ...
  'banned_ips' => [],
  'languages' => SAI_ENGINE_LANGUAGES,
  'custom_languages' => [
    'English (en)',
    'German (de)', 
    'French (fr)',
...
define( 'SAI_ENGINE_ALL_LANGUAGES', [
  'aa' => 'Afar',
  'ab' => 'Abkhazian',
  'af' => 'Afrikaans',
  'ak' => 'Akan',
